class Solution:
    def isPos(self,s1,s2,s3,sub_s1_len,sub_s2_len,sub_s3_len,is_intrlv):
        ...
        while s1_idx > 0 and s1[s1_idx-1] == s3[s3_idx-1]:
            cnt += 1
            is_intrlv[(sub_s3_len,sub_s1_len,sub_s2_len)] |= is_intrlv[(sub_s3_len-cnt,sub_s1_len-cnt,sub_s2_len)]
            s1_idx -= 1
            s3_idx -= 1
        cnt = 0
        s3_idx = sub_s3_len
        while s2_idx > 0 and s2[s2_idx-1] == s3[s3_idx-1]:
            cnt += 1
            is_intrlv[(sub_s3_len,sub_s1_len,sub_s2_len)] |= is_intrlv[(sub_s3_len-cnt,sub_s1_len,sub_s2_len-cnt)]
            s2_idx -= 1
            s3_idx -= 1
    ...
    def isInterleave(self, s1: str, s2: str, s3: str) -> bool:
        ...
        for sub_s3_len in range(1,s3_len+1):
            ...
            while sub_s2_len >= 0 and sub_s1_len <= s1_len:
                ...
                sub_s2_len -= 1
                sub_s1_len += 1
        return is_intrlv[(s3_len,s1_len,s2_len)]
